#ifndef ___SRC_COMMON_CORE_ECS_CHUNK_H___
#define ___SRC_COMMON_CORE_ECS_CHUNK_H___
...
namespace NextLevel
{
	namespace ecs
	{
		...
		public:
			 ...
			 */
			std::uint32_t CreateEntity(const utils::EntityIndex& _index, const utils::EntityVersion& _version)
			{
			...
			void MoveEntity(std::size_t& _chunkIndex, Entity& _entity, Chunk& _other)
			{
				...
				utils::EntityIndex oldChunkIndex = _chunkIndex;
				utils::EntityIndex newChunkIndex = _other.m_Size++;
...
#endif //!___SRC_COMMON_CORE_ECS_CHUNK_H___