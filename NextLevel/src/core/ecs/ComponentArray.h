#ifndef ___SRC_CORE_ECS_COMPONENTARRAY_H___
#define ___SRC_CORE_ECS_COMPONENTARRAY_H___
...
namespace ecs
{
	...
	*/
	...
	public:
		...
		*/
		CompT& operator[](const int _index)
		{
...
#endif //!___SRC_CORE_ECS_COMPONENTARRAY_H___